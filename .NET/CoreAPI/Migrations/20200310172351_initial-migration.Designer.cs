...
namespace CoreAPI.Migrations
{
    ...
    [Migration("20200310172351_initial-migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreAPI.Data.Camp", b =>
                {
            ...
            modelBuilder.Entity("CoreAPI.Data.Location", b =>
                {
                    b.Property<int>("LocationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CoreAPI.Data.Speaker", b =>
                {
            ...
            modelBuilder.Entity("CoreAPI.Data.Talk", b =>
                {
            ...
            modelBuilder.Entity("CoreAPI.Data.Camp", b =>
                {
                    b.HasOne("CoreAPI.Data.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("CoreAPI.Data.Talk", b =>
                {
                    b.HasOne("CoreAPI.Data.Camp", "Camp")
                        .WithMany("Talks")
                        .HasForeignKey("CampId");

                    b.HasOne("CoreAPI.Data.Speaker", "Speaker")
                        .WithMany()
